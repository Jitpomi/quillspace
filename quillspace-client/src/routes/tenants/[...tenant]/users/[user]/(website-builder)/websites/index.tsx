...
export default component$(() => {
    ...
    const showCredentials = useSignal<boolean>(false);
    ...
    const renderIcon = $((iconName: string, className: string = "w-8 h-8") => {
        ...
        if (iconName.startsWith('/') || iconName.includes('.')) {
            return <img src={iconName} alt="Builder logo" class={`${className} object-contain`} width="32"
                        height="32"/>;
        }
        ...
        <div class="max-w-6xl mx-auto p-6">
            ...
            {!showCredentials.value ? (
                <>
                    ...
                    {!serviceType.value ? (
                        <div class="mb-8">
                            <h2 class="text-xl font-semibold text-gray-900 mb-6">How would you like to manage your
                                website?</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
                                ...
                                >
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-blue-50 to-blue-100 opacity-5 group-hover:opacity-10 transition-opacity"></div>

                                    <div class="relative p-8">
                                        <div class="flex items-start gap-4 mb-4">
                                            <div
                                                class="flex items-center justify-center w-12 h-12 bg-white rounded-lg shadow-sm border border-gray-200">
                                                <LuUser class="w-6 h-6 text-[#9CAF88]"/>
                                            </div>
                                            <div class="flex-1">
                                                <h3 class="text-lg font-semibold text-gray-900 mb-2">I have my own
                                                    accounts</h3>
                                                <p class="text-gray-600 text-sm leading-relaxed">
                                                    Connect your existing Wix, WordPress, or Squarespace accounts. You
                                                    maintain full control and ownership of your websites.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                                            <strong>Best for:</strong> Users with existing websites or technical
                                            experience
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-[#9CAF88] to-[#7A9B6E] opacity-5 group-hover:opacity-10 transition-opacity"></div>
                                    ...
                                    <div class="relative p-8">
                                        <div class="flex items-start gap-4 mb-4">
                                            ...
                                            <div class="flex-1">
                                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Build and manage
                                                    for me</h3>
                                                <p class="text-gray-600 text-sm leading-relaxed">
                                                    QuillSpace creates and manages your website using our professional
                                                    accounts. Focus on writing while we handle the technical details.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                                            <strong>Best for:</strong> Authors who want a hassle-free, fully managed
                                            solution
                                        </div>
                                    </div>
                                </div>
                            ...
                            {serviceType.value === 'diy' ? (
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {builders.map((builder) => (
                                        ...
                                        >
                                            <div
                                                class={`absolute inset-0 bg-gradient-to-br ${builder.color} opacity-5 group-hover:opacity-10 transition-opacity`}></div>
                                ...
                                <div class="max-w-3xl">
                                    <div
                                        class="bg-gradient-to-br from-[#9CAF88]/10 to-[#7A9B6E]/10 rounded-xl p-8 border border-[#9CAF88]/20">
                                        <div class="flex items-start gap-4 mb-6">
                                            <div
                                                class="flex items-center justify-center w-16 h-16 bg-white rounded-xl shadow-sm border border-gray-200">
                                                <LuShield class="w-8 h-8 text-[#9CAF88]"/>
                                            </div>
                                            <div>
                                                <h3 class="text-2xl font-semibold text-gray-900 mb-2">We'll Build Your
                                                    Perfect Author Website</h3>
                                                <p class="text-gray-600 leading-relaxed">
                                                    Our team of designers and developers will create a stunning,
                                                    professional website tailored specifically for authors.
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                            ...
                                            <div class="bg-white/50 rounded-lg p-4">
                                                <h4 class="font-semibold text-gray-900 mb-2">🚀 Coming Soon: AI Website
                                                    Generator</h4>
                                                <p class="text-sm text-gray-600">
                                                    We're developing an AI agent that will automatically generate a
                                                    fully functional,
                                                    personalized author website based on your preferences and writing
                                                    style.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white rounded-lg p-6 border border-gray-200">
                                            <div class="text-center">
                                                <h4 class="text-lg font-semibold text-gray-900 mb-2">Ready to Get
                                                    Started?</h4>
                                                <p class="text-gray-600 mb-4">
                                                    Contact our team to discuss your website needs and get a custom
                                                    quote.
                                                </p>
                                                <div class="flex justify-center">
                                                    <button
                                                        ...
                                                        class="bg-[#9CAF88] cursor-pointer text-white px-8 py-3 rounded-lg hover:bg-[#9CAF88]/90 transition-colors font-medium flex items-center gap-2"
                                                    >
                ...
                <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-6">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            {selectedBuilder.value === 'jflux' ? (
                                <div class="space-y-4">
                                    <p class="text-sm text-gray-600">
                                        JFlux is our native website builder. Click continue to start creating your
                                        website.
                                    </p>
                                ...
                                <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onInput$={(e) => {
                                                        credentials.value = {
                                                            ...credentials.value,
                                                            siteId: (e.target as HTMLInputElement).value
                                                        };
                                                    }}
                                                />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onInput$={(e) => {
                                                        credentials.value = {
                                                            ...credentials.value,
                                                            siteUrl: (e.target as HTMLInputElement).value
                                                        };
                                                    }}
                                                />
                                            </div>
                                    ...
                                    <div class="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                                        ...
                                        Your credentials are encrypted and stored securely. We only use them to manage
                                        your website on your behalf.
                                    </div>
