/**
 * Customization Wizard - Guides authors through personalizing their (website-builder)
 */
...
const steps: CustomizationStep[] = [
  ...
  },
  {
    id: 'preview',
    title: 'Preview',
    description: 'See your beautiful (website-builder) come to life',
    icon: LuCheck
  }
];
...
export default component$<CustomizationWizardProps>(({ onStartEditing }) => {
        ...
        <div class="flex justify-between items-center mt-8 pt-6 border-t border-[#E8E2D4]">
          ...
          {currentStep.value === steps.length - 1 ? (
            <button
              ...
              class="flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-gentle hover-lift"
            >
              Start Editing
            ...
            <button
              onClick$={nextStep}
              class="flex items-center gap-2 px-6 py-3 bg-[#9CAF88] hover:bg-[#8a9e7a] text-white rounded-lg font-medium transition-gentle hover-lift"
            >
              Continue
              <LuArrowRight class="w-4 h-4" />
            </button>
